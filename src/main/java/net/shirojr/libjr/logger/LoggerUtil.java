package net.shirojr.libjr.logger;

import net.fabricmc.loader.api.FabricLoader;
import net.shirojr.libjr.LibJR;
import org.jetbrains.annotations.Nullable;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class LoggerUtil {
    public static final Logger LOGGER = LoggerFactory.getLogger(LibJR.MODID);
     ...
     *
     * @param input Informative text of the current state of the mod, to display in the game console
     * @param type Will display texts differently in the instance's console
